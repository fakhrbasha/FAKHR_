...
export default function PostAction({ postId, likes, setLikes }) {
  ...
  return (
    <div className="grid grid-cols-3 w-full px-5 my-3 border-t border-divider pt-4">
      ...
      <button
        ...
        className="flex flex-row justify-center items-center w-full space-x-3 cursor-pointer"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width={27}
